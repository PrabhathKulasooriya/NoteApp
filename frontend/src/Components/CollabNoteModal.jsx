...
import { X, Tag, Type, AlignLeft } from "lucide-react";
...
const CollabNoteModal = ({ setModalOpen, existingNote = null }) => {
  ...
  const handleSave = async () => {
    ...
    try { 
        const response = await axios.post(
          `/api/notes/updateShared/${existingNote._id}`,
          noteData,
          {
            headers: { token: token },
          },
...
export default CollabNoteModal;
